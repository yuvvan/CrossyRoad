...
def process(im):
    ...
    _ , contours = cv2.findContours(erode, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
...
#=============================#
#initialization
cap = cv2.VideoCapture('/Users/yuvvan_talreja/Desktop/Coding/CrossyRoad/test-video.mp4') #load a video
...
while(cap.isOpened()):
    ...
    img = np.array(Image.fromarray(frame).resize(size=(H, W)))
